...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4" style="background-color: #2d5ceb;
        padding:10px; 
        border-radius:10px">
                ...
                <form id="calcForm" action="/action_page.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" onchange="totalPrice()" id="Pages" required value="1"
                            min="1" max="400" step="1">
                    </div>
                    <div
                        style="width:auto;height:60px;border:2px solid #ffd700;margin-bottom:10px; background-color:#121954;">
                        <h4 style="font-size:15px; color:#fff;">Total Price :<span id="totalPrice"></span></h4>
                    </div>

                    <button type="submit" class="btn btn-warning pull-right" style="border-radius: 50px;">Continue to
                        Order</button>
                </form>
                <div class="col-sm-2">
                </div>
