...
<section id="hero-area" class="bg-3 bg-cover" data-scroll-index="0">
    <div class="container">
        <div class="row">
            <div class="col-sm-10" style="background-color: #2d5ceb;
            padding:10px; 
            border-radius:10px;border:3px solid #ffd700;
            margin:130px 0;">
                <h3 style="color: #fff; text-align: center;">ORDER DETAILS</h3>

                <form id="mainCalc" action="/action_page.php">
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <label style="color: #fff" for="sel1">First Name</label>
                                <input class="form-control" type="text" name="topic">
                            </div>
                        </div>
                        <div class="col-sm">
                            <div class="form-group">
                                <label style="color: #fff" for="sel1">Last Name</label>
                                <input class="form-control" type="text" name="topic">
                            </div>
                        </div>
                        <div class="col-sm">
                            <div class="form-group">
                                <label style="color: #fff" for="sel1">Email *</label>
                                <input class="form-control" type="text" name="topic">
                            </div>
                        </div>
                    </div>
