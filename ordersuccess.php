...
$body = 'Dear Batman, <br>Below are your new order details<br>' . 'Name: ' .  $fname . ' ' .$lname . '<br>Email: ' . $email . '<br>Amount Paid: ' . $amount . '<br>Paper Type: ' . $paperType . '<br>Unit Title: ' . $unitTitle . '<br>Unit Code: ' . $unitCode . '<br>Paper Format: ' . $paperFormat . '<br>Preferred English: ' . $preferedEnglish. '<br>Number of Sources: ' . $sources . '<br>Pages: ' . $pages . '<br>Topic:' . $topic . '<br>Subject: ' . $subject . '<br>Instructions: ' . $instructions; 
            ...
            <div class="col-lg-8 offset-lg-2">
                <div class="batconfidential-card">
                    <div class="container">
                        ...
                        <p class="text-light font-weight-normal">Your order details have been submitted and sent to
                            a
                            qualified writer.</p>
                        <p class="text-light font-weight-normal">We will keep you updated on the progress of your
                            order.
                        </p>
                        <p class="text-light font-weight-normal">Click 'PAY NOW' to complete the order process.
                        </p>
                    </div>
                </div>
            </div>
